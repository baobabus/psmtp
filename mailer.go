...
func (this *Mailer) Send(msg *Message) error {
	...
	if err := this.waitForConn(); err != nil { return err; }
	...
	if err := c.Mail(msg.smtpFrom()); err != nil { return err; }
	// TODO Convert to glog
...
func (this *Mailer) validate(msg *Message) error {
	if msg == nil { return errors.New("No message"); }
	if msg.From.Address == "" { return errors.New("Empty sender"); }
	if len(msg.To) == 0 { return errors.New("No recipients"); }
	for _, r := range msg.To {
		if r.Address == "" { return errors.New("Empty recipient"); }
	}
	return nil
}
